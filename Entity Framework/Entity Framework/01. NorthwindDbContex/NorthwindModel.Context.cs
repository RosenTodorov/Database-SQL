...
namespace _01.NorthwindDbContex
{
    ...
    public partial class NorthwindEntities : DbContext
    {
        ...
        public virtual int usp_GetIncomeByGivenCompany(string customerID)
        {
            var customerIDParameter = customerID != null ?
                new ObjectParameter("CustomerID", customerID) :
                new ObjectParameter("CustomerID", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_GetIncomeByGivenCompany", customerIDParameter);
        }
    }
}
